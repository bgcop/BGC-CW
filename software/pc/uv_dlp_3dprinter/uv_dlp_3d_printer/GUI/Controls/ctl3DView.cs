...
namespace UV_DLP_3D_Printer.GUI.Controls
{
    public partial class ctl3DView : UserControl
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (m_modelAnimTmr != null)
                return;
            //m_camera.ResetViewAnim(180, 0, 0, 0, 10);
            //m_axisCam.ResetViewAnim(180, 0, 0, 0, 10);
            m_camera.ResetView(290, 0, 0, 10, 10);
            //m_camera.ResetViewAnim(100, 0, -120, 90, 20);
            //m_axisCam.ResetViewAnim(0, 0, -120, 90, 20);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            //m_camera.ResetViewAnim(180, 0, 0, 0, 10);
            //m_axisCam.ResetViewAnim(180, 0, 0, 0, 10);
            m_camera.ResetView(290, -290, 0, 30, 10);
            //m_camera.ResetViewAnim(100, 0, -120, 90, 20);
            //m_axisCam.ResetViewAnim(0, 0, -120, 90, 20);
