...
namespace Engine3D
{
    ...
    public class Engine3d
    {
        ...
        public void AddGrid() 
        {
            ...
            {
                AddLine(new PolyLine3d(new Point3d((float)x, (float)-hysz, 0), new Point3d((float)x, (float)hysz, 0), Color.Black));
            }
            for (double y = -hysz; y < hysz; y += 10)
            {
                AddLine(new PolyLine3d(new Point3d((float)-hxsz, (float)y, 0), new Point3d((float)hxsz, (float)y, 0), Color.Black));
            }
            /*
        ...
        void AddPlatWalls1()
        {
            ...
            platY = (float)UVDLPApp.Instance().m_printerinfo.m_PlatYSize / 2;
            platZ = (float)UVDLPApp.Instance().m_printerinfo.m_PlatZSize;
            m_walls1 = Quad3d.CreateQuadBox(-platX, platX, -platY, platY, 0, -1);
        }
        ...
        public void RenderGL(bool alpha) 
        {
            ...
            try
            {
                ...
                foreach (Object3d obj in m_objects)
                {
                    Color objColor = Color.FromArgb(255,65,145,241);
